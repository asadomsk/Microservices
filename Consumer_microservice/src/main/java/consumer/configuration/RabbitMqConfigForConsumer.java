...
import consumer.service.ConsumeEvents;

@SuppressWarnings("unused")
@Configuration
public class RabbitMqConfigForConsumer implements RabbitListenerConfigurer {

	// Spring application uses the PayloadArgumentResolver to extract, convert, and
	// set the
	// converted message to the method parameter annotated with the @RabbitListener
	// annotation.
	@Bean
	...
	// Overridding this method we can set the custom
	// DefaultMessageHandlerMethodFactory where we set the
	// message converter and the factory will create our PayloadArgumentResolver
	// with the correct convert.
	@Override
